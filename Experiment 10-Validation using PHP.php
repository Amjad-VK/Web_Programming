...
<tr>
 ...
 <tr>
  <td> gender</td>
  <td> <input type="radio" id="gen_m" value='male' name="gen">male<br><input type="radio" value='female' id="gen_f" name="gen">female</td>
 </tr>
...
else
{
    if(strlen($pass)<8)
    {
    echo "$d $a Password must cotain atleast 8 characters $b";
    exit;
    }
}
$cpa=$_POST["cpa"];
...
echo "$d $b Registraction sucessfully complteted.... $c";
